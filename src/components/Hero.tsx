  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 space-y-8 max-w-4xl mx-auto">
        <h1 className="font-sans text-6xl md:text-8xl font-extrabold text-carnitas-primary uppercase tracking-tight mb-6 animate-fadeIn drop-shadow-[2px_2px_0_rgba(34,34,34,1)] border-2 border-white p-4">
          Authentic Mexican
          <br />
