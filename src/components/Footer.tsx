    ...
    <footer className="bg-carnitas-text relative">
      ...
      <div className="container mx-auto px-4 py-12 relative">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-sketch text-white mb-4">Carnitas</h3>
            <p className="font-handwritten text-lg text-gray-300">
              Experience authentic Mexican cuisine with our signature carnitas dishes.
            </p>
          </div>
          <div>
            <h4 className="text-lg font-sketch text-white mb-4">Quick Links</h4>
            <ul className="space-y-2 font-handwritten text-lg">
              <li>
          ...
          <div>
            <h4 className="text-lg font-sketch text-white mb-4">Connect With Us</h4>
          ...
          <div>
            <h4 className="text-lg font-sketch text-white mb-4">Newsletter</h4>
            <div className="flex flex-col space-y-2">
              <Input
                type="email"
                placeholder="Enter your email"
                className="bg-white/10 border-white/20 text-white placeholder:text-gray-400 font-handwritten"
              />
              <Button className="sketch-button bg-carnitas-yellow text-carnitas-text hover:bg-yellow-400">
                Subscribe
              </Button>
            </div>
          </div>
        </div>
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-gray-300 font-handwritten">
