...
const MenuSection = () => {
  ...
  if (isLoading) {
    return (
      <section className="pt-48 bg-mexican-pattern bg-cover bg-center min-h-screen relative">
        <div className="container mx-auto px-8 py-12 mb-12 bg-carnitas-blackTransparent rounded-lg shadow-lg relative z-10">
